 ...
 *
 * <p>Performance-critical paths are constrained through explicit budgets for rendering and
 * spill-to-disk behavior. Document byte limits are caller policy metadata and are not enforced by
 * the library during open/probe.
 */
public record PdfProcessingPolicy(
  ...
  public static final long DEFAULT_MAX_DOCUMENT_BYTES = Long.MAX_VALUE;
