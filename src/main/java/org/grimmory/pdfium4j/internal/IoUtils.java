...
public final class IoUtils {
  ...
  private static final FileAttribute<Set<PosixFilePermission>> OWNER_ONLY_FILE =
      IS_POSIX ? PosixFilePermissions.asFileAttribute(PosixFilePermissions.fromString("rw-------")) : null;

  private static final FileAttribute<Set<PosixFilePermission>> OWNER_ONLY_DIR =
      IS_POSIX ? PosixFilePermissions.asFileAttribute(PosixFilePermissions.fromString("rwx------")) : null;
  ...
  private static void enforceOwnerOnlyPermissions(Path path, boolean executable) throws IOException {
