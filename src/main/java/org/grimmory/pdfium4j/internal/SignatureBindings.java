...
public final class SignatureBindings {
  ...
  private static final StableValue<MethodHandle> FPDFSignatureObj_GetByteRange_SV =
      StableValue.of();
  ...
  private static final StableValue<MethodHandle> FPDFSignatureObj_GetSubFilter_SV =
      StableValue.of();
