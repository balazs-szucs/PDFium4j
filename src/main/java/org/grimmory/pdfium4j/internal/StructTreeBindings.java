...
/**
 * FFM bindings for PDFium accessibility and logical structure functions from {@code fpdf_structtree.h}.
 */
public final class StructTreeBindings {
  ...
  public static final MethodHandle FPDF_StructTree_GetChildAtIndex =
      downcallCritical("FPDF_StructTree_GetChildAtIndex", FunctionDescriptor.of(ADDRESS, ADDRESS, JAVA_INT));

  // Structure Element functions
  public static final MethodHandle FPDF_StructElement_GetType =
      downcall("FPDF_StructElement_GetType", FunctionDescriptor.of(JAVA_LONG, ADDRESS, ADDRESS, JAVA_LONG));

  public static final MethodHandle FPDF_StructElement_GetAltText =
      downcall("FPDF_StructElement_GetAltText", FunctionDescriptor.of(JAVA_LONG, ADDRESS, ADDRESS, JAVA_LONG));

  public static final MethodHandle FPDF_StructElement_GetActualText =
      downcall("FPDF_StructElement_GetActualText", FunctionDescriptor.of(JAVA_LONG, ADDRESS, ADDRESS, JAVA_LONG));

  public static final MethodHandle FPDF_StructElement_GetLang =
      downcall("FPDF_StructElement_GetLang", FunctionDescriptor.of(JAVA_LONG, ADDRESS, ADDRESS, JAVA_LONG));

  public static final MethodHandle FPDF_StructElement_CountChildren =
      downcallCritical("FPDF_StructElement_CountChildren", FunctionDescriptor.of(JAVA_INT, ADDRESS));

  public static final MethodHandle FPDF_StructElement_GetChildAtIndex =
      downcallCritical("FPDF_StructElement_GetChildAtIndex", FunctionDescriptor.of(ADDRESS, ADDRESS, JAVA_INT));
