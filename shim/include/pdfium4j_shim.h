...
FPDF_EXPORT int FPDF_CALLCONV pdfium4j_get_meta_utf8(FPDF_DOCUMENT doc, const char* key, char* buf, int buf_len);

FPDF_EXPORT int FPDF_CALLCONV pdfium4j_set_meta_utf8(FPDF_DOCUMENT doc, const char* key, const char* value_utf8);


FPDF_EXPORT int FPDF_CALLCONV pdfium4j_set_custom_xmp(FPDF_DOCUMENT doc,
                            const char* namespace_uri,
                            const char* prefix,
                            const char* key,
                            const char* value_utf8);

FPDF_EXPORT int FPDF_CALLCONV pdfium4j_get_custom_xmp(FPDF_DOCUMENT doc,
                            const char* namespace_uri,
                            const char* key,
                            char* buf,
                            int   buf_len);

FPDF_EXPORT int FPDF_CALLCONV pdfium4j_get_custom_xmp_bag(FPDF_DOCUMENT doc,
                                const char* namespace_uri,
                                const char* key,
                                char* buf,
                                int   buf_len);

FPDF_EXPORT int FPDF_CALLCONV pdfium4j_set_custom_xmp_bag(FPDF_DOCUMENT doc,
                                const char* namespace_uri,
                                const char* prefix,
                                const char* key,
...
FPDF_EXPORT int FPDF_CALLCONV pdfium4j_get_xmp_metadata(FPDF_DOCUMENT doc, char* buf, int buf_len);
...
FPDF_EXPORT int FPDF_CALLCONV pdfium4j_text_get_chars_with_bounds(FPDF_TEXTPAGE text_page,
                                                                   int start_index,
                                                                   int count,
                                                                   void* out_data);


FPDF_EXPORT int FPDF_CALLCONV pdfium4j_save_incremental(FPDF_DOCUMENT doc, const char* out_path);
FPDF_EXPORT int FPDF_CALLCONV pdfium4j_save_copy(FPDF_DOCUMENT doc, const char* out_path);
